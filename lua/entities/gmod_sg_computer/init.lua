...
for _,filename in pairs(file.Find("entities/gmod_sg_computer/screens/*.lua","LUA")) do AddCSLuaFile("entities/gmod_sg_computer/screens/"..filename) end
